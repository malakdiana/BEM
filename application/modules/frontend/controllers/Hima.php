    ...
    if ($this->input->is_ajax_request()) {
      ...
      if ($this->form_validation->run()) {
        ...
        if ($validate->isError()) {
          ...
          $insert_role_access[] = array(
            'permission' => strtolower($controllers) . "_list",
          ...
          if (count($show_in_view) > 0) {
            ...
            $insert_role_access[] = array(
              'permission' => strtolower($controllers) . "_detail",
              'definition' => "Module " . strtolower($controllers)
            );
          }
          ...
          if (count($show_in_add) > 0) {
            ...
            $insert_role_access[] = array(
              'permission' => strtolower($controllers) . "_add",
              'definition' => "Module " . strtolower($controllers)
            );
          }
          ...
          if (count($show_in_update) > 0) {
            ...
            $insert_role_access[] = array(
              'permission' => strtolower($controllers) . "_update",
              'definition' => "Module " . strtolower($controllers)
            );
          }
          ...
          $insert_role_access[] = array(
            'permission' => strtolower($controllers) . "_delete",
            'definition' => "Module " . strtolower($controllers)
          );
