...
class Struktur_organisasi_model extends MY_Model{
  ...
  private $column_order = array('path');
  private $order        = array('struktur_organisasi.id'=>"DESC");
  private $select       = "struktur_organisasi.id,struktur_organisasi.path";
...
public function __construct()
  ...
  private function _get_datatables_query()
    ...
    if($this->input->post("path"))
        {
          $this->db->like("struktur_organisasi.path", $this->input->post("path"));
        }
