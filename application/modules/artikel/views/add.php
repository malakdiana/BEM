    ...
    <div class="card m-b-30">
      ...
      <div class="card-body">
        <form action="<?= $action ?>" id="form" autocomplete="off">
          ...
          <div class="form-group">
            <label>Content</label>
            <textarea class="form-control text-editor" rows="3" data-original-label="content" name="content"></textarea>
            <div id="content"></div>
          </div>

          <div class="form-group">
            <label>CreatedOn</label>
            <input type="datetime-local" class="form-control form-control-sm" placeholder="CreatedOn" name="createdOn" id="createdOn">
          </div>
          ...
          <div class="form-group">
            ...
            --->
            <?= is_select("organisasi", "organisasi_id", "id", "nama"); ?>
          </div>
